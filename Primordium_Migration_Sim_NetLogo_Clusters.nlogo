...
to go ;When the "go" button is pushed on the interface, is procedure is run repeatedly until the button is pressed again
  ...
  ask links [hide-link];[set color grey] ;Recolors new links to be grey
...
export-view (word repetitions "_WntFrac" Wnt-fraction "_s" Wnt-spring-constant "_f" fgf-speed "_w" wnt-speed "_t" ticks ".png")
  ...
  <experiment name="Cluster_Images" repetitions="1" runMetricsEveryStep="false">
    <setup>setup
export-view (word "run" repetitions "_s" Wnt-spring-constant "_t" ticks ".png")</setup>
    <go>go
if (ticks = 1) or (ticks = 5) or (ticks = 10) or (ticks = 50) or (ticks = 250) or (ticks = 500) or (ticks = 1000) or (ticks = 2000)[
export-view (word "run" repetitions "_s" Wnt-spring-constant "_t" ticks ".png")
]</go>
    <timeLimit steps="2000"/>
    <steppedValueSet variable="repetitions" first="1" step="1" last="10"/>
    <steppedValueSet variable="wnt-spring-constant" first="0.14" step="0.02" last="0.2"/>
    <enumeratedValueSet variable="density-scale">
      <value value="36"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="cluster-threshold">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="wnt-fraction">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="cxcl12a-speed">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fgf-speed">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
